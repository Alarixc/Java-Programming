...
public class Personal implements GetDetails{
   ...
   public void setAmount(){
    ...
    public void display(){
        ...
        if(income() < 300000){
            ...
            System.out.println("Congrats! You are eligible for this Personal loan. Your loan amount assigned to you is: " + amount());
        }
